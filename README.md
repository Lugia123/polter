...
| `task_assign` 🔑  | Say which terminal is doing it; id `0` takes it back off somebody without cancelling it. Assigning is not telling — the worker learns what it's doing from what you `terminal_send` it, because the group doesn't wake it. |
