...
const tools = [_]Tool{
    .{
        .name = "me",
        .description = "Which terminal this agent is running in, and whether it is supervising or supervised. When it is watched, `sampling` says whether anything is measuring it, with the same three values terminal_list documents: `starting` (not confirmed yet, not a fault), `running`, `failed`.",
        .schema =
