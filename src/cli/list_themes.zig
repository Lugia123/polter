...
pub fn run(gpa_alloc: std.mem.Allocator) !u8 {
    ...
    if (resources_dir == null)
        try stderr.print("Could not find the Polter resources directory. Please ensure " ++
            "that Polter is installed correctly.\n", .{});
...
const Preview = struct {
    ...
    pub fn run(self: *Preview) !void {
        ...
        try self.vx.setTitle(writer, "👻 Polter Theme Preview 👻");
        ...
        switch (self.mode) {
            ...
            .save => {
                ...
                const save_instructions = [_][]const u8{
                    "To apply this theme, add the following line to your Polter configuration:",
                    "",
                    ...
                    "Then add the following line to your Polter configuration and reload:",
                    "",
                    "config-file = ?auto/theme.ghostty",
                    "",
                    "For more details on configuration and themes, visit the Polter documentation:",
                    "",
